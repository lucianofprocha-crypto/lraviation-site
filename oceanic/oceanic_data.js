...
var OCEANIC = [
 {phase:"FLIGHT PLANNING", items:[
  ...
  {t:"CONTINGENCY PROCEDURES", n:"Review procedures and plans",
   a:"Review GPS jamming/spoofing impact and the reporting requirements (NAT OPS Bulletin 2025-001, in the Bulletins card below)."},
 ]},
 ...
 {phase:"PRIOR TO OCEANIC ENTRY", items:[
  ...
  {t:"DIVERSION AIRPORTS", n:"Update weather, TAFs and NOTAMs for the ETP / diversion airports",
   a:"Threats and vulnerabilities review for the crossing."},
 ]},
 {phase:"AFTER OCEANIC ENTRY", items:[
  {t:"TRANSPONDER", n:"Squawk 2000, 10 minutes after the OEP — except in the Reykjavik CTA and when transitioning Bermuda radar (retain the assigned code)",
   a:"Consider selecting TCAS to BELOW for the cruise."},
  ...
  {t:"VHF", n:"Set air-to-air VHF #2 123.45 and guard VHF #1 121.5 MHz",
   a:"Consider setting VHF #3 to COM (from DATA) to stop constant connection attempts enroute — reset to DATA before the OXP (if applicable)."},
  {t:"SLOP", n:"Centreline to 2 NM RIGHT of the ATC cleared track, in 0.1 NM increments (aircraft capable) — never a LEFT offset",
 ...
 {phase:"10 MINUTES AFTER WAYPOINT PASSAGE", items:[
  {t:"RECORD", n:"Record time and LAT/LONG on the plotting chart",
   a:"10 minutes or 2° of longitude after the waypoint. Use the NON-STEERING LRNS — or the nav-display method (FMS aircraft, smallest scale)."},
 ]},
 ...
 {phase:"COAST IN", items:[
  ...
  {t:"NAV ACCURACY", n:"Compare a ground-based NAVAID with the LRNS when back in coverage"},
 ]},
 {phase:"POST FLIGHT", items:[
  {t:"NAV ACCURACY CHECK", n:"At destination / on blocks", f:["IRS #1 drift","IRS #2 drift","IRS #3 drift","Residual GS"]},
  {t:"WRITE-UPS", n:"RVSM and datalink write-ups in the maintenance log, as applicable"},
 ]},
];
